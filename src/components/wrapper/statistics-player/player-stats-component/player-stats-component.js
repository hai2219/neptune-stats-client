...
export default class PlayerStatsComponent extends Component {
    ...
    render() {
        ...
        let bodyData3 = [
            ["01", "Sarah Love", <Integer key={1} className="order" min={1} max={999}/>,<Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={3} />, <Float numOfDecimal={2} min={0} max={999}  key={4} />],
            ["02", "Issau Rave", <Integer key={1} className="order" min={1} max={999}/>,<Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={3} />, <Float numOfDecimal={2} min={0} max={999}  key={4} />],
            ["03", "Sandran Muc", <Integer key={1} className="order" min={1} max={999}/>,<Float numOfDecimal={2} min={0} max={999}  key={2} />,<Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={3} />, <Float numOfDecimal={2} min={0} max={999}  key={4} />],
            ["04", "Bati Huci", <Integer key={1} className="order" min={1} max={999}/>,<Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={3} />, <Float numOfDecimal={2} min={0} max={999}  key={4} />],
            ["06", "Doti Hane", <Integer key={1} className="order" min={1} max={999}/>, <Float numOfDecimal={2} min={0} max={999}  key={2} />,<Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={3} />, <Float numOfDecimal={2} min={0} max={999}  key={4} />],
            ["09", "Pharan Candia", <Integer key={1} className="order" min={1} max={999}/>,<Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={2} />, <Float numOfDecimal={2} min={0} max={999}  key={3} />, <Float numOfDecimal={2} min={0} max={999}  key={4} />],
            ];
